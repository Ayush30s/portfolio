    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          {/* Social Links */}
          <div
            className={`flex items-center justify-around p-6 rounded-2xl border mt-auto ${dark ? "bg-white border-gray-200 shadow-lg" : "bg-neutral-900 border-neutral-800 shadow-xl"}`}
          >
            <a
              href="https://www.linkedin.com/in/ayush-srivastav-58635b280"
              target="_blank"
              rel="noopener noreferrer"
              className={`p-3 rounded-xl transition-all hover:scale-110 ${dark ? "bg-gray-50 text-blue-700 hover:bg-blue-50" : "bg-neutral-800 text-gray-300 hover:text-blue-400"}`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`p-3 rounded-xl transition-all hover:scale-110 ${dark ? "bg-gray-50 text-gray-900 hover:bg-gray-200" : "bg-neutral-800 text-gray-300 hover:text-white"}`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`p-3 rounded-xl transition-all hover:scale-110 ${dark ? "bg-gray-50 text-gray-900 hover:bg-blue-50 hover:text-blue-500" : "bg-neutral-800 text-gray-300 hover:text-blue-400"}`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
