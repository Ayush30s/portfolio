  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Experience 1 */}
        <div
          className={`flex-1 p-6 md:p-8 rounded-xl border transition-all duration-300 hover:-translate-y-1 ${dark ? "bg-gray-50 border-gray-200 hover:shadow-lg" : "bg-neutral-800 border-neutral-700 hover:shadow-2xl hover:shadow-blue-900/20"}`}
        >
          <div className="flex justify-between items-start mb-4">
            <div>
              <h2
                className={`text-2xl font-bold ${dark ? "text-blue-600" : "text-blue-400"}`}
              >
            ...
            <span
              className={`px-3 py-1 rounded-full text-xs font-semibold ${dark ? "bg-blue-100 text-blue-700" : "bg-blue-900/50 text-blue-300"}`}
            >
              Sept 2025 - Present
            </span>
          </div>
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {[
              ...
              <span
                key={tech}
                className={`px-2 py-1 text-xs rounded-md ${dark ? "bg-gray-200 text-gray-700" : "bg-neutral-700 text-gray-300"}`}
              >
                {tech}
              </span>
            ))}
        ...
        >
          <div className="flex justify-between items-start mb-4">
            ...
            <span
              className={`px-3 py-1 rounded-full text-xs font-semibold ${dark ? "bg-gray-200 text-gray-700" : "bg-neutral-700 text-gray-300"}`}
            >
              Nov 2024 - June 2025
            </span>
          </div>
      ...
      <div
        className={`p-6 md:p-8 rounded-xl border mt-4 ${dark ? "bg-blue-50 border-blue-100" : "bg-blue-950/20 border-blue-900/30"}`}
      >
        <h3
          className={`text-xl font-bold mb-4 ${dark ? "text-gray-900" : "text-white"}`}
        >
